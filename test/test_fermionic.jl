import GradedArrays
using GradedArrays: SectorArray, SectorDelta, SectorRange, dual, sectors
using Random: randn!
...
@testset "fermion_permutation_phase" begin
    ...
    delta_even = SectorDelta{Float64}(
    ...
    delta_mixed = SectorDelta{Float64}(
...
@testset "SectorArray permutedims applies fermionic phase" begin
