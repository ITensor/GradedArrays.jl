...
@testset "SectorOneTo" begin
    @testset "U1 construction and accessors" begin
        si = SectorOneTo(TKS.U1Irrep(1), 3, false)
    ...
    @testset "SU2 construction and accessors" begin
        ...
        si = SectorOneTo(TKS.SU2Irrep(1 // 2), 4, false)
    ...
    @testset "flip with SU2" begin
        si = SectorOneTo(TKS.SU2Irrep(1 // 2), 2, false)
        sif = flip(si)
    ...
    @testset "equality" begin
        si1 = SectorOneTo(TKS.U1Irrep(1), 3, false)
        si2 = SectorOneTo(TKS.U1Irrep(1), 3, false)
        si3 = SectorOneTo(TKS.U1Irrep(1), 3, true)
        si4 = SectorOneTo(TKS.U1Irrep(2), 3, false)
        si5 = SectorOneTo(TKS.U1Irrep(1), 4, false)
    ...
    @testset "sector_type" begin
        @test sector_type(SectorOneTo{TKS.U1Irrep}) == SectorRange{TKS.U1Irrep}
        @test sector_type(SectorOneTo{TKS.SU2Irrep}) == SectorRange{TKS.SU2Irrep}
    end
    ...
    @testset "show" begin
        ...
        sid = SectorOneTo(TKS.U1Irrep(1), 3, true)
