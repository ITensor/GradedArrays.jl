...
@testset "GradedOneTo" begin
    @testset "gradedrange from raw TKS.Sector labels (U1)" begin
        ...
        @test g isa GradedOneTo{TKS.U1Irrep}
    ...
    @testset "sector_type" begin
        @test sector_type(GradedOneTo{TKS.U1Irrep}) == SectorRange{TKS.U1Irrep}
        @test sector_type(GradedOneTo{TKS.SU2Irrep}) == SectorRange{TKS.SU2Irrep}
    end
    ...
    @testset "SU2 gradedrange" begin
        ...
        @test g isa GradedOneTo{TKS.SU2Irrep}
        @test blocklength(g) == 2
